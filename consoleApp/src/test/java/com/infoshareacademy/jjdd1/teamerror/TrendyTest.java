...
//            new CurrencyFileFilter(new OnDemandFilesContent()));
    ...
    public void CURRENCY_TEST_for_empty_parameter_should_return_empty_map() throws Exception {
        ...
        //when
        Map<Integer, Double> result = trendy.calculateMonthPercentageDeviations(emptyList);
    ...
    public void CURRENCY_TEST_should_return_percentage_deviation_for_first_month() {
        ...
        //when
        Map<Integer, Double> result = trendy.calculateMonthPercentageDeviations(listOfOneObject);
    ...
    public void CURRENCY_TEST_should_return_percentage_deviations_for_all_months() {
        ...
        //when
        Map<Integer, Double> result = trendy.calculateMonthPercentageDeviations(listOfObjectsOf12Months);
    ...
    public void CURRENCY_TEST_should_return_percentage_deviations_for_6_months() {
        ...
        //when
        Map<Integer, Double> result = trendy.calculateMonthPercentageDeviations(listOfObjectsOf6Months);
    ...
    public void CURRENCY_TEST_should_return_percentage_deviations_for_all_months_in_5_years() {
        ...
        //when
        Map<Integer, Double> result = trendy.calculateMonthPercentageDeviations(listOfObjectsOf5Years);
